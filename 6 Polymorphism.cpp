...
class Employee :AbstractEmployee {		// za da polzvame funkciqta AskForPromotion, (:AbstractEmployee) - nasledqva go uj
private:
	string Company;
	int Age;
...
public:
	...
	virtual void Work() {																	//napraehme q virtual za da moje drugite clasove da polzvat svoqta funkiq 
...
public:
	...
	void Work() {																			// copirahme work funkciqta sas drugi cout prostotii
...
public:
	...
	void Work() {
		cout << Name << " is teaching " << Subject << endl;							// copirahme work funkciqta sas drugi cout prostotii
	}
};
...
int main()
{
	...
	Employee* e1 = &d;
	Employee* e2 = &t;					//pointers...
	e1->Work();
	e2->Work();							//vikane na pointers??
